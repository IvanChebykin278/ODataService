...
import TreeBinding from '../../TreeBinding';
import CountMode from '../CountMode';
import ChangeReason from '../../ChangeReason';
import Filter from '../../Filter';
import Sorter from '../../Sorter';
import ODataUtils from '../ODataUtils';
import TreeBindingUtils from '../../TreeBindingUtils';
import OperationMode from '../OperationMode';
import SorterProcessor from '../../SorterProcessor';
...
import isEmptyObject from '../../../../base/util/isEmptyObject';
	...
	ODataTreeBinding.prototype._applyAdapter = function () {
		...
		if (this.bHasTreeAnnotations) {
			...
			if (this.oTreeProperties[sMagnitudeAnnotation] && this.sOperationMode == OperationMode.Server) {
				...
				var ODataTreeBindingFlat = require("../ODataTreeBindingFlat");
				ODataTreeBindingFlat.apply(this);
			} else {
				// apply hierarchical paging adapter
				var ODataTreeBindingAdapter = require("../ODataTreeBindingAdapter");
	...
	*/
	...
	export default ODataTreeBinding;