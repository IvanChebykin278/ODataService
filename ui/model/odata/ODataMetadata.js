...
import OData from '../../thirdparty/datajs';
import CacheManager from '../../core/cache/CacheManager';
import Utils from './_ODataMetaModelUtils';
	...
	*/
	...
	ODataMetadata.prototype._createRequest = function(sUrl) {
		...
		var oDefaultHeaders = {
			...
			oLangHeader = {
				"Accept-Language": document.getElementsByTagName('html').lang
			};
