...
import escapeRegExp from '../../base/strings/escapeRegExp';
import deepEqual from '../../base/util/deepEqual';
import JSTokenizer from '../../base/util/JSTokenizer';
import Measurement from '../performance/Measurement';
	...
	var fnUndefined = CONSTANT.bind(null, undefined),
		mDefaultGlobals = {
			...
			"odata": {
				...
				// 	ODataUtils = require("../model/odata/v4/ODataUtils");
				// 	return ODataUtils.compare.apply(ODataUtils, arguments);
				// },
				"fillUriTemplate": function (sExpression, mData) {
					if (!URI.expand) {
						///* URITemplate = */ sap.ui.require("sap/ui/thirdparty/URITemplate");
					}
				...
				"uriEncode": function () {
					...
					ODataUtils = require("../model/odata/ODataUtils");
