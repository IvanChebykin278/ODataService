...
import BindingMode from './ui/model/BindingMode';
import Context from './ui/model/Context';
import Model from './ui/model/Model';
import ODataAnnotations from './ui/model/odata/v2/ODataAnnotations';
import ODataUtils from './ui/model/odata/ODataUtils';
import CountMode from './ui/model/odata/CountMode';
import UpdateMethod from './ui/model/odata/UpdateMethod';
import OperationMode from './ui/model/odata/OperationMode';
import MessageScope from './ui/model/odata/MessageScope';
import ODataMetadata from './ui/model/odata/ODataMetadata';
import FilterProcessor from  './ui/model/FilterProcessor';
import ODataMetaModel from './ui/model/odata/ODataMetaModel';
import MessageParser from './ui/core/message/MessageParser';
import ODataMessageParser from './ui/model/odata/ODataMessageParser';
import OData from './ui/thirdparty/datajs';
import Log from './base/Log';
import assert from './base/assert';
import uid from './base/util/uid';
import UriParameters from './base/util/UriParameters';
import deepEqual from './base/util/deepEqual';
import merge from './base/util/merge';
import encodeURL from './base/security/encodeURL';
import jQuery from './ui/thirdparty/jquery';
import isPlainObject from './base/util/isPlainObject';
import each from './base/util/each';
import isEmptyObject from './base/util/isEmptyObject';
import URI from './ui/thirdparty/URI';

	var ODataModel = Model.extend("sap.ui.model.odata.v2.ODataModel", {
		...
		constructor : function(sServiceUrl, mParameters) {
			...
			this.oHeaders["Accept-Language"] = document.getElementsByTagName("html")[0].leng;
